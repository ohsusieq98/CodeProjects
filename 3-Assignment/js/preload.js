...
function preloadImages()
{
	...
	{
		//loadingMessage.innerHTML = '<h1>Bunny<br>Hunt IV</h1><p>The Good Friday Massacre</p>';
        loadingMessage.innerHTML = '<h1>' + _("Bunny Hunt IV")'</h1><p>' _("The Good Friday Massacre") + '</p>';
        
		//loadingMessage.innerHTML += ('<input class="button" id="startButton" type="button" value="let\'s shoot some bunnies!" onClick="ready()">');
	...
	else
	{
        ...
        loadingMessageP.innerHTML = _("Images loaded:") 
        "<strong>" + (currImage + 1) + "/"+ imageArray.length + "</strong>";
