...
function endGame()
{
	...
	var verb = _("splattered");
	
	switch (randomMessage)
	{
		case 1:
			verb = _("Bunnies eviscerated");
			break;
		case 2:
			verb = _("Bunnies mutilated");
			break;
		case 3:
			verb = _("Bunnies massacred");
			break;
		case 4:
			verb = _("Bunnies butchered");
			break;
	}
...
function levelUp()
{
	...
	levelMessage.innerHTML = level  + _(" Level ");
